...
$username_err  = "";
if(empty(trim($_POST["sr"]))){
    $username_err = "Username cannot be blank";
}

if ($error) {
    echo "<p> <font color=green>Currently Some Fields Are Empty </font></p>";
...
//   window.alert("YOU can't leave fields Empty");
    ...
    if ($conn->query($sql) === TRUE) {
      echo "<p> <font color=green>New record created successfully</font></p>";
    } else {
    ...
    <div class="main-block">
        ...
        <!-- <form action="details.php" method="post"> -->
            <div class="title">
                ...
                <!-- <h2>Quiz Details <span class="error"><?php echo $username_err;?></span></h2> -->
                <h2>Quiz Details </h2>
            </div>
            ...
            <div class="info">
                ...
                <input type="text" name="sr" id="sr" placeholder="Course Name">
            </div>
