...
$query = " SELECT * FROM quiz_data2 ORDER BY ID LIMIT 0,3 ";
$data  = mysqli_query($conn,$query);
$total = mysqli_num_rows($data);


$conn2  = mysqli_connect('localhost','root','','flag');
$query2 = " SELECT * FROM flag_data WHERE number='third' ";
 ...
 console.log(bulvalue);
    ...
    function updateCountdown() {
        ...
        if (time == 0) {
           <?php 
           //----------
           $update2 = "UPDATE `flag_data` SET bool_value='1' WHERE number='third' ";
